    ...
    */
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, InterruptedException {
        ...
        try {
            ...
            System.out.println("====================\n");
            printAllMessages(collection, retries);            
    ...
    private static void printAllMessages (MongoCollection<Document> collection, RetryPolicy retries) throws InterruptedException {
        try {
            // Return all messages
